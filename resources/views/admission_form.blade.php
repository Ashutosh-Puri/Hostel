...
<body>
    <div class="container-md">
        ...
        <section name="page_2" style="break-after:page;">
            ...
            <div class="admission_form3">
                <div class="row">
                    ...
                    <div class="row mx-3 mt-3">
                            <div class="col-12 col-sm-2">
                                <label class="form-label" for="search">विद्यार्थ्यांचे नाव : </label>
                            </div>
                            <div class="col-12 col-sm-3">
                                <label class="form-label text-start" for="search"><strong>Suyash Popat Pawar</strong></label>
                            </div>
                    ...
                    <div class="row mt-3 mx-3">
                        <div class="col-12 col-sm-6">
                            <div>पालकांचे पूर्ण नांव : <strong> S.P.Pawar </strong> </div>
                        </div>
                        <div class="col-12 col-sm-6 text-center">
                            <label class="form-label text-center" for="#">फोन नं : <strong> 1234567890 </strong> </label>
                        </div>
                    </div>
                    <div class="row mx-3 mt-2">
                        <div class="col-12">
                           पत्ता:-  <strong>चिखली ता.संगमनेर जि. अहमदनगर</strong>
                        </div>
                    </div>
                    <div class="row mt-4 mx-3">
                        <div class="col-12 col-sm-6">
                            <div class="col-12 col-sm-6"><strong>दिनांक: 12 / 12 / 2023</strong></div>
                        </div>
                        <div class="col-12 col-sm-6 text-center">
                            <label class="form-label text-center" for="#">पालकांची सही : <strong>S.P.Pawar</strong></label>
                        </div>
                    </div>
                </div>
            </div>
