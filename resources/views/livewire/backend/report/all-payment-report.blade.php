                    ...
                    <div class="row">
                        ...
                        <span class="col-12 col-md-10 p-0">
                            <div class="row ">
                                ...
                                <div class="col-6 col-md-1  ">
                                    <select class="w-100 py-1"  wire:loading.attr="disabled" wire:model.change="year_id">
                                ...
                                <div class="col-6 col-md-2 ">
                                    <select class="w-100 py-1" wire:loading.attr="disabled" wire:model.change="class_id">
                                ...
                                <div class="col-6 col-md-2">
                                    <select class="w-100 py-1" wire:loading.attr="disabled" wire:model.change="payment">
                                ...
                                <div class="col-6 col-md-1">
                                    <select class="w-100 py-1" wire:loading.attr="disabled" wire:model.change="payment_status">
