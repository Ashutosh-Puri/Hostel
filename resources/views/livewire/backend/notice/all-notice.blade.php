                                ...
                                <div class="row">
                                    <div class="col-12 col-md-10">
                                        <div class="mb-3 form-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" wire:model.live="name" value="{{ old('name') }}" id="name" placeholder="Enter Notice Name">
                                            @error('name')
                                    ...
                                    <div class="col-12 col-md-12">
                                        <div class="mb-3 form-group">
                                            ...
                                            <textarea class=" w-100 @error('description') is-invalid @enderror" wire:model.live.debounce.1000ms="description" id="description" placeholder="Enter Notice Description"   cols="30" rows="5">{{ old('description') }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
