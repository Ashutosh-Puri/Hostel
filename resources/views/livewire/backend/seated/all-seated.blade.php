                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="mb-3 form-group">
                                            ...
                                            <input type="text" class="form-control @error('seated') is-invalid @enderror" wire:model.live="seated" value="{{ old('seated') }}" id="seated" placeholder="Enter Seated Number">
                                            @error('seated')
                                ...
                                <div class="row">
                                    ...
                                    <span class="col-12 col-md-9 p-0">
                                        <span class="row">
                                            ...
                                            <div class="col-12 col-md-3">
                                                <input class="w-100" wire:model.live.debounce.1000ms="seated_number" type="search" placeholder="Seated Number">
                                            </div>
                                        </span>
                                    </span>
                                </div>
