                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="mb-3 form-group">
                                            ...
                                            <input type="text" class="form-control @error('subject') is-invalid @enderror" wire:model.live="subject" value="{{ old('subject') }}" id="subject" placeholder="Enter Subject">
                                            @error('subject')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-12 col-md-12">
                                        <div class="mb-3 form-group">
                                            ...
                                            <textarea class="w-100 @error('message') is-invalid @enderror" wire:model.live.debounce.1000ms="message" id="message" placeholder="Enter Message"   cols="30" rows="5">{{ old('message') }}</textarea>
                                            @error('message')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                            ...
                            <div class="float-end">
                                ...
                                @can('Add Contact')
                                    <a wire:loading.attr="disabled"  wire:click="setmode('add')"class="btn btn-success ">
                                        Add Contact<span class="btn-label-right mx-2"><i class=" mdi mdi-plus-circle fw-bold"></i></span>
                                    </a>
                                @endcan
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <span class="col-12 col-md-9 p-0">
                                        <span class="row">
                                            ...
                                            <div class="col-12 col-md-3">
                                                <input  class="w-100" wire:model.live.debounce.1000ms="search" type="search" placeholder="Name">
                                            </div>
                                        </span>
                                    </span>
                                </div>
                                    ...
                                    <tbody>
                                        @foreach ($contact as $key => $item)
                                            <tr wire:key='{{ $item->id }}'>
                                                ...
                                                <td>{{ $item->email }}</td>
                                                <td>{{ $item->subject }}</td>
                                                <td class="text-wrap lh-lg">{{ $item->message }}</td>
                                                <td>
                                                    @if ( $item->status == '0')
                                                        <span class="badge bg-danger text-white">Not Read</span>
                                                    @else
