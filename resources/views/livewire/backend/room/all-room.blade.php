                                ...
                                <div class="row">
                                    ...
                                    <span class="col-12 col-md-9 p-0">
                                        <span class="row">
                                            ...
                                            <div class="col-12 col-md-3">
                                                    <input class="w-100" wire:model.debounce.1000ms="f" type="number" min="0" placeholder="Floor Number">
                                            </div>
                                            <div class="col-12 col-md-3">
                                                    <input class="w-100" wire:model.debounce.1000ms="r" type="search" placeholder="Room Label">
                                            </div>
                                        </span>
                                    </span>
                                </div>
