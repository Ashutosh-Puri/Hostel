                            ...
                            <div class="card-body">
                                <form wire:submit.prevent="save" method="post" action="" id="myForm">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <input type="date"
                                                    ...
                                                    wire:model.debounce.1000ms="date" value="{{ old('date') }}"
                                                    id="date">
                                                @error('date')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <input type="time"
                                                    class="form-control @error('exittime') is-invalid @enderror"
                                                    wire:model.debounce.1000ms="exittime" value="{{ old('exittime') }}"
                                                    id="exittime" placeholder="Enter exit time">
                                                @error('exittime')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <div class="mb-3 form-group">
                                                <label for="reasone" class="form-label">Hostel Leaving Reasone</label>
                                                <textarea class="form-control @error('reasone') is-invalid @enderror" wire:model.debounce.1000ms="reasone"
                                                    id="reasone" placeholder="Enter Reasone To Leave Hostel" cols="30" rows="3">{{ old('reasone') }}</textarea>
                                                @error('reasone')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
