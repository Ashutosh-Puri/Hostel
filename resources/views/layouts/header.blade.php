...
<div class="navbar-custom">
    ...
    <div class="container-fluid">
        ...
        <ul class="list-unstyled topnav-menu float-end mb-0">
            <li>
                <a href="" class="text-white nav-link dropdown-toggle arrow-none waves-effect waves-light" >
            ...
            <li class="dropdown notification-list topbar-dropdown">
                ...
                <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <img src="{{ (!empty(auth()->user()->photo)) ? asset(auth()->user()->photo) : asset('assets/images/no_image.jpg') }}" alt="user-image" class=" d-inline rounded-circle">
                ...
                <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="d-inline">
                        ...
                        this.closest('form').submit();" type="submit" class="dropdown-item notify-item" ><i class="fa fa-sign-out"></i>
