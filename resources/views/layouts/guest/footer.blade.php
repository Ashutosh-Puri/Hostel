    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <a class="btn btn-link" href=""><span class="mdi mdi-chevron-right"></span>About Us</a>
                <a class="btn btn-link" href=""><span class="mdi mdi-chevron-right"></span>Contact Us</a>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="mdi mdi-map-marker me-2"></i>123 Street, New York, USA</p>
                <p class="mb-2"><i class="mdi mdi-phone me-2"></i>+012 345 67890</p>
                <p class="mb-2"><i class="mdi mdi-gmail me-2"></i>info@example.com</p>
