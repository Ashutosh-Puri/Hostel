...
<div class="sidebar-bg">
  <nav class=" sidebar-bg text-white sidebar vh-100 sidebar-offcanvas overflow-scroll " id="sidebar">
    <ul class="nav">
      ...
      <li class="nav-item">
        <a wire:navigate  class="nav-link" data-turbolinks="false" href="{{ route('admin.dashboard') }}">
      ...
      @canany(['Access Academic Year', 'Access Class', 'Access Admission','Access Allocation','Access Attendance', 'Access RFID','Access Merit List'])
        ...
        @can('Access Academic Year')
          <li class="nav-item">
            <a wire:navigate   class="nav-link" href="{{ route('all_academic_year') }}">
        ...
        @can('Access Class')
        <li class="nav-item">
          <a wire:navigate  class="nav-link" href="{{ route('all_class') }}">
        ...
        @can('Access Admission')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_admission') }}">
        ...
        @can('Access Allocation')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_allocation') }}">
        ...
        <li class="nav-item">
          <a wire:navigate  class="nav-link" href="{{ route('all_attendance') }}">
        ...
        @can('Access RFID')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('admin_assgin_rfid') }}">
        ...
        <li class="nav-item">
          <a wire:navigate  class="nav-link" href="{{ route('all_merit_list') }}">
      ...
      @canany(['Access Fee', 'Access Fine', 'Access Student Payment','Access Student Fine','Access Transaction'])
        ...
        @can('Access Fee')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_fee') }}">
        ...
        @can('Access Fine')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_fine') }}">
        ...
        @can('Access Student Payment')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_student_payment') }}">
        ...
        @can('Access Student Fine')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_student_fine') }}">
        ...
        @can('Access Transaction')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_transaction') }}">
      ...
      @canany(['Access Enquiry Form', 'Access Student Local Register Form', 'Access Student Night Out Form','Access Student Come From Home Form'])
        ...
        @can('Access Enquiry Form')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_enquiry') }}">
        ...
        @can('Access Student Night Out Form')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_student_night_out') }}">
        ...
        @can('Access Student Local Register Form')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_student_local_register') }}">
        ...
        @can('Access Student Come From Home Form')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_student_come_from_home') }}">
      ...
      @can('Access College')
        <li class="nav-item">
          <a wire:navigate  class="nav-link" href="{{ route('all_college') }}">
      ...
      @can('Access Hostel')
        <li class="nav-item">
          <a wire:navigate  class="nav-link" href="{{ route('all_hostel') }}">
      ...
      @can('Access Building')
        <li class="nav-item">
          <a wire:navigate  class="nav-link" href="{{ route('all_building') }}">
      ...
      @can('Access Floor')
        <li class="nav-item">
          <a wire:navigate  class="nav-link" href="{{ route('all_floor') }}">
      ...
      @can('Access Seated')
        <li class="nav-item">
          <a wire:navigate  class="nav-link" href="{{ route('all_seated') }}">
      ...
      @can('Access Room')
        <li class="nav-item">
          <a wire:navigate  class="nav-link" href="{{ route('all_room') }}">
      ...
      @can('Access Bed')
        <li class="nav-item">
          <a wire:navigate  class="nav-link" href="{{ route('all_bed') }}">
    ...
    @endcanany
      ...
      @canany(['Access Student Report', 'Access Allocation Report', 'Access Room Report','Access Payment Report','Access Attendance Report'])
        ...
        @can('Access Student Report')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_student_report') }}">
        ...
        @can('Access Attendance Report')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_attendance_report') }}">
              <span class="icon-bg"><i class="mdi mdi-file-chart menu-icon"></i></span>
        ...
        @can('Access Allocation Report')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_allocation_report') }}">
              <span class="icon-bg"><i class="mdi mdi-file-chart menu-icon"></i></span>
        ...
        @can('Access Room Report')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_room_report') }}">
              <span class="icon-bg"><i class="mdi mdi-file-chart menu-icon"></i></span>
        ...
        @can('Access Payment Report')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_payment_report') }}">
              <span class="icon-bg"><i class="mdi mdi-file-chart menu-icon"></i></span>
      ...
      @canany(['Access Role', 'Access Permission', 'Access Role Wise Permission','Access Admin'])
        ...
        @can('Access Role')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_role') }}">
        ...
        @can('Access Permission')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_permission') }}">
              <span class="icon-bg"><i class="mdi mdi-account-key menu-icon"></i></span>
        ...
        @can('Access Role Wise Permission')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_role_permission') }}">
              <span class="icon-bg"><i class="mdi mdi-account-key menu-icon"></i></span>
        ...
        @can('Access Admin')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_admin') }}">
      ...
      <li class="nav-item nav-category">Other</li>
        @can('Access Student')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_student') }}">
        ...
        @can('Access Cast')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_cast') }}">
        ...
        @can('Access Category')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_category') }}">
        ...
        @can('Access Facility')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_facility') }}">
        ...
        @can('Access Quota')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_quota') }}">
        ...
        @can('Access Notice')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_notice') }}">
        ...
        @can('Access Photo Gallery')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_photogallery') }}">
        ...
        @can('Access Rule')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_rule') }}">
              <span class="icon-bg"><i class="mdi mdi-information-outline menu-icon"></i></span>
        ...
        @can('Access Student Education')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_student_education') }}">
        ...
        @can('Access Contact')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('all_contact') }}">
      ...
      @canany(['Access Site Setting'])
        ...
        @can('Access Site Setting')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('site_setting') }}">
      ...
      @canany(['Access Razorpay Orders', 'Access Razorpay Payments', 'Access Razorpay Refunds'])
        ...
        @can('Access Razorpay Orders')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('razorpay_orders') }}">
        ...
        @can('Access Razorpay Payments')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('razorpay_payments') }}">
        ...
        @can('Access Razorpay Refunds')
          <li class="nav-item">
            <a wire:navigate  class="nav-link" href="{{ route('razorpay_refunds') }}">
      ...
      <li class="nav-item">
        <a wire:navigate  class="nav-link" data-bs-toggle="collapse" href="#auth" aria-expanded="false" aria-controls="auth">
        ...
        <div class="collapse" id="auth">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a wire:navigate  class="nav-link" href="pages/samples/blank-page.html"> Blank Page </a></li>
            <li class="nav-item"> <a wire:navigate  class="nav-link" href="pages/samples/login.html"> Login </a></li>
            <li class="nav-item"> <a wire:navigate  class="nav-link" href="pages/samples/register.html"> Register </a></li>
            <li class="nav-item"> <a wire:navigate  class="nav-link" href="pages/samples/error-404.html"> 404 </a></li>
            <li class="nav-item"> <a wire:navigate  class="nav-link" href="pages/samples/error-500.html"> 500 </a></li>
          </ul>
        </div>
      </li> --}}
     {{-- <li class="nav-item nav-category">Setting</li>
      <li class="nav-item sidebar-user-actions">
        <div class="sidebar-user-menu">
          <a wire:navigate  href="#" class="nav-link"><i class="mdi mdi-settings menu-icon"></i>
      ...
      <li class="nav-item sidebar-user-actions">
        <div class="sidebar-user-menu">
          <a wire:navigate  href="#" class="nav-link"><i class="mdi mdi-speedometer menu-icon"></i>
            <span class="menu-title">Take Tour</span></a>
        </div>
      </li>
      <li class="nav-item sidebar-user-actions">
        <div class="sidebar-user-menu">
          <a wire:navigate  href="#" class="nav-link"><i class="mdi mdi-logout menu-icon"></i>
